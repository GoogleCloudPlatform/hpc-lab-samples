...
module "slurm_cluster_network" {
  source = "../../third-party/slurm-gcp/tf/modules/network"
...
module "slurm_cluster_controller" {
  source = "../../third-party/slurm-gcp/tf/modules/controller"
...
module "slurm_cluster_login" {
  source = "../../third-party/slurm-gcp/tf/modules/login"
...
module "slurm_cluster_compute" {
  source = "../../third-party/slurm-gcp/tf/modules/compute"
